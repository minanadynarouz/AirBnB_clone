...
class TestBaseModel(unittest.TestCase):
    ...
    def test_to_dict_method(self):
        """Test return value of the to_dict method of BaseModel class"""
...
class TestDocumentation(unittest.TestCase):
    ...
    def test_module_documentation(self):
        """Test documentation for the base_model"""
        module = self.new_base.__module__
        self.assertIsNotNone(module.__doc__)

    def test_self_documentation(self):
        """Tests for this documentation for classes"""
